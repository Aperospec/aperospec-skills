# Aperospec Team Productivity Protocol

## 1. 生产力的新定义
生产力的目标不再是“自动跑完无脑流程”，而是：
- **能处理碎片化输入**：不需要一次性提供完美文档。
- **能组织多 Skill 协作**：Runtime 能够有效主持 Council Mode。
- **能形成可讨论草稿**：产出具有讨论价值的 Team Synthesis Brief。
- **能根据人类反馈局部返工**：精准将反馈分配到正确层级，避免无意义的全盘重写。
- **能在定稿后稳定生产**：一旦人类确认并冻结方案，系统能可靠地执行 Production Mode 并输出高质量最终产物。

## 2. 团队纪律
- 不跨权：各 Skill 只负责本领域，Project 绝不能越权去写视觉页面。
