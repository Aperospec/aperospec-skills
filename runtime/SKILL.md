...
### Stage 1: Cognitive Engine (`project.skill`) -> CWP
### Stage 2: Narrative Universe (`cinema.skill`) -> NWP
### Stage 3: Concept Deck (`conceptdeck.skill`) -> CDP
### Stage 4: Visual Director (`visualdirector.skill`) -> VDP
