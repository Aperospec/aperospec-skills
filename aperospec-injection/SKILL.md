...
description: Use Aperospec Injection as the content injection and structure fusion engine. It analyzes existing user content, detects layers, and confirms formal names. In Council Mode, it provides material attribution and lock advice.
---
...
`aperospec-injection.skill` is not a creative skill. Its core responsibility is analyzing existing user content and correctly connecting it to the Aperospec organization. 
