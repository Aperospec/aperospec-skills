...
- if the new content introduces new locked names, prebuilt structure, narrative material, or visual guidelines from another layer, rerun `aperospec-injection`
- if the new content changes Skip / Lock / Assisted Generation decisions, rerun `aperospec-injection`
