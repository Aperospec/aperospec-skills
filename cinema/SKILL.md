---
name: cinema
description: Use Cinema as a Narrative Translation API. In Council Mode, it provides narrative judgments without formal output. In Production Mode, it outputs the Narrative World Package (NWP).
---
